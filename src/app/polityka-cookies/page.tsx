  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-page__content">
        ...
        <p>Po wybraniu Nowego Sącza albo Bobowej zapisujemy w pamięci lokalnej przeglądarki wartość <code>fuks-branch</code>. Dzięki temu nie pytamy o oddział przy każdym wejściu. Możesz ją usunąć w ustawieniach danych witryny w swojej przeglądarce.</p>
        ...
        <p>W ustawieniach przeglądarki możesz przeglądać i usuwać dane zapisane dla tej domeny. Wyłączenie pamięci lokalnej nie blokuje dostępu do treści, ale może spowodować ponowne wyświetlenie wyboru oddziału.</p>
