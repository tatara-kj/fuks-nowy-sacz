...
export const courses: Course[] = [
  ...
  },
  {
    ...
    ageDetails: [
      ...
      "Z odpowiednią kwalifikacją zawodową możliwe są niższe progi wieku.",
      "Od 3 września 2026 r. wejdą dodatkowe wyjątki dla przewozów krajowych i określonych linii regularnych.",
    ],
    ...
    important: "Na stronie pokazujemy stan prawny z 17 sierpnia 2026 r. Zmian obowiązujących od 3 września 2026 r. nie łączymy z zasadami aktualnymi — konkretny wariant potwierdzimy przed zapisem.",
    professional: true,
    sourceUrl: govCategories,
  },
  {
